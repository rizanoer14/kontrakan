                  ...
                  <tbody>
                    ...
                    while($data = mysqli_fetch_assoc($result))
                    {
                     ...
                     echo "<tr>";
                        ...
                        echo '<td>
                        <a href="edit.php?id='.$data['id_pelanggan'].'" <button type="button" class="btn btn-success bi bi-pencil" style="height:40px;width:90px"> Edit</button></a>  
                        <a href="delete.php?id='.$data['id_pelanggan'].'"
